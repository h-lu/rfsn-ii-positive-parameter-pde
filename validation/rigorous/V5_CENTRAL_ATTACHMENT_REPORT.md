...
|---|---:|
| \(q_1^2\) | \([1.2153596147703547,1.494598850379016]\) |
| \(q_1\) | \([1.1024334967563143,1.2225378727790060]\) |
| \(\Pi\) | \([0.55053508858003052,0.61107548478183316]\) |
| \(P\) | \([-1.1729631816953666,-1.1358421538700991]\) |
| \(V\) | \([-15.884515771116039,-15.798968072107765]\) |
| \(Q\) | \([-9.3919691362822971,-9.0906313883214071]\) |
...
\[
 0.027036818304633003,\qquad
 0.11548422888396103,\qquad
 0.090631388321407158.
\]

The fixed section and the energy coordinate are uniformly transverse:

\[
 |P|\ge1.1358421538700991,
 \qquad |Q|\ge9.0906313883214071.
\tag{4}
\]
