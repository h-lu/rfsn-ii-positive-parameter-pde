...
\[
 ...
 \epsilon\in[4/5,6/5],\quad |b|\le1.3\times10^{-4},
...
|---|---:|
| \(q_1^2\) | \([1.2153634076492665,1.494594661240727]\) |
| \(q_1\) | \([1.1024352169852278,1.2225361594818895]\) |
| \(\Pi\) | \([0.5505400885800306,0.6110704847818331]\) |
| \(P\) | \([-1.1729535826629254,-1.1358516164798769]\) |
| \(V\) | \([-15.884486122281537,-15.798995210383922]\) |
| \(Q\) | \([-9.39195598799889,-9.09064452817628]\) |
...
\[
 0.027046417337074136,\qquad
 0.11551387771846322,\qquad
 0.09064452817628066.
\]
...
\[
 |P|\ge1.1358516164798769,
 \qquad |Q|\ge9.09064452817628.
\tag{4}
\]
