...
| V6 | The positive-parameter van der Pol system has an exhaustive high-winding return/first-exit relation with two compatible action finite parts. | Proposed | V2--V5A plus clean stratified persistence and exact-action assembly |
