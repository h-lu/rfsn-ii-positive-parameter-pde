...
[Theorem V4](van-der-pol/OUTER_FUTURE_STAYING.md).  Attaching that tail
through \(K_1\) to the central algebraic-directed sheet and every later
theorem-sized claim retain the statuses in the
