...
child, `V2.CHART.ANALYTIC_NORMAL_FORM`, now also passes locally from the
  ...
  exact action preservation.  These aggregates remain non-claim-bearing
  because independent replay is 1/2.  The remaining three P2d children, P2e,
