...
- `Locally validated`: supported by an outward-rounded interval computation on
  the locked current-machine toolchain; independent replay is still pending.
...
| V2E-AX | Direct exact zero-energy radial chart containing the complete true \(\nu=0\) P2bK source curve on the v2 proper phase arc, together with the criterion that a complete strict zero-action event skeleton with \(m_{\rm ax}>0\) persists on some uniform \(0<\delta_{\rm ent}\le2^{-55}\); [`P2E_AXIS_SOURCE_CHART.md`](P2E_AXIS_SOURCE_CHART.md), [`check_p2e_axis_chart.py`](../validation/rigorous/check_p2e_axis_chart.py), and [`P2E_AXIS_CHART_REPORT.md`](../validation/rigorous/P2E_AXIS_CHART_REPORT.md) | `LOCAL-AMENDMENT / Proved + locally validated source-chart lemma` | Restricted P2b0 supplies the \(5\times10^{-6}\) true-graph tube and P2bK supplies the \(C^2\) direct source phase. Exact Hamiltonian elimination, the rational phase sector, and compact first-hit stability give local mathematical `PASS`. The POLE first hit now has a complete non-claim-bearing computed-interval design cover; ALG, the joint incidence/census, \(m_{\rm ax}\), transported traces, and `V2.EVENT_ATLAS` remain open. No full \(2^{-55}\) action disc is claimed. | None |
...
| V8 | Negative centered-moment criterion for a real positive co-periodic temporal eigenvalue of any true smooth periodic stationary profile; [`A2_PERIODIC_SPECTRAL_INSTABILITY.md`](../van-der-pol/A2_PERIODIC_SPECTRAL_INSTABILITY.md) | `LOCAL-AMENDMENT / Proved` | V1 time PDE, periodic stationary equations, and the self-adjoint operator-pencil argument | None |
| V8A | True periodic profile in the frozen A2 shooting box with \(M_{0.01}<0\), hence a real co-periodic eigenvalue \(\lambda_*\in(0.01,2)\); [`validation/a2_periodic`](../validation/a2_periodic/README.md) | `LOCAL-AMENDMENT / Locally validated; non-claim-bearing` | V8 plus the locked CAPD/FILIB 53-dimensional multiple-shooting Krawczyk inclusion and the augmented interval integral on the same root enclosure.  The local mathematical gates pass; independent-machine replay remains the only promotion requirement. | None |
| V9 | Whole-line centered-moment criterion for a real positive \(L^2\) temporal eigenvalue of an exponentially localized stationary homoclinic, including the correction for unbounded \((-\partial_x^2)^{-1}\) and an explicit essential-spectrum gap; [`PULSE_1_SPECTRAL_INSTABILITY.md`](../van-der-pol/PULSE_1_SPECTRAL_INSTABILITY.md) | `LOCAL-AMENDMENT / Proved` | V1 time PDE, localized stationary equations, the self-adjoint operator pencil, and the far-field Fourier symbol | None |
| V9A | The P2c selected primary homoclinic at the frozen `pulse_1` target has \(M_{0.01}<0\), hence a real whole-line \(L^2\) eigenvalue \(\lambda_*\in(0.01,2)\); [`validation/pulse_1`](../validation/pulse_1/README.md) | `LOCAL-AMENDMENT / Locally validated; non-claim-bearing` | V9, the P2c true selected homoclinic and two-piece exponential tail, target-point Krawczyk-to-selected-cell containment, and the augmented interval integral.  Independent-machine replay remains the only promotion requirement. | None |
| V10 | Exact exclusion of classical stationary finite-wavenumber Turing onset from stable homogeneous kinetics, including the frozen-box margin; [`CLASSICAL_STATIONARY_TURING_EXCLUSION.md`](../van-der-pol/CLASSICAL_STATIONARY_TURING_EXCLUSION.md) | `LOCAL-AMENDMENT / Proved` | V1 time PDE and its exact homogeneous Fourier symbol | None |
| V11 | A real positive temporal eigenvalue implies nonlinear orbital Lyapunov instability in \(H^1\), modulo translations; [`NONLINEAR_ORBITAL_INSTABILITY.md`](../van-der-pol/NONLINEAR_ORBITAL_INSTABILITY.md) | `LOCAL-AMENDMENT / Proved` | V1 time PDE, analytic-semigroup time map, and the positive eigenvalue hypothesis | None |
| V11A | The frozen A2 true periodic profile is nonlinearly orbitally unstable to co-periodic \(H^1\) perturbations | `LOCAL-AMENDMENT / Locally validated; non-claim-bearing` | V8A and V11; independent replay of V8A remains required | None |
| V11B | The frozen `pulse_1` true localized profile is nonlinearly orbitally unstable to localized whole-line \(H^1\) perturbations | `LOCAL-AMENDMENT / Locally validated; non-claim-bearing` | V9A and V11; independent replay of V9A remains required | None |
| S1 | Temporal stability of any B2 or V7 profile | `LOCAL-AMENDMENT / Deferred` | A claim-bearing stability conclusion requires a complete spectral exclusion in the relevant perturbation class and a nonlinear stability argument.  V11 instead supplies an instability bridge whenever a positive eigenvalue is present. | None |
...
| D-VAN-DER-POL-TURING-EXCLUSION | Exact homogeneous Fourier symbol and incompatibility between temporal homogeneous stability, \(f'(a)>0\), and a stationary zero eigenvalue at positive wavenumber, \(f'(a)\leq-2r^2\sqrt{\epsilon}<0\), including the exact \(49/25\) frozen-box margin and both neutral branches; [`CLASSICAL_STATIONARY_TURING_EXCLUSION.md`](../van-der-pol/CLASSICAL_STATIONARY_TURING_EXCLUSION.md) | `LOCAL-AMENDMENT / Proved` | V1 time PDE and its homogeneous equilibrium | Excludes only local classical stationary Turing onset from a stable homogeneous state; it does not exclude a branch born outside the box and continued into it, finite-wavenumber growth on an already unstable background, a nonlinear branch, or pattern selection | None |
...
| D-VAN-DER-POL-PERIODIC-MOMENT-INSTABILITY | A negative centered-moment functional gives a negative direction for a self-adjoint temporal operator pencil and hence a real positive co-periodic eigenvalue; [`A2_PERIODIC_SPECTRAL_INSTABILITY.md`](../van-der-pol/A2_PERIODIC_SPECTRAL_INSTABILITY.md) | `LOCAL-AMENDMENT / Proved` | The physical time PDE and any true smooth periodic stationary profile satisfying the displayed strict moment inequality | This is a conditional profile criterion.  It does not by itself enclose the frozen A2 seed, treat nonzero Bloch phases or a whole-line pulse, prove nonlinear instability, or select a pattern dynamically | None |
| N-VAN-DER-POL-A2-MOMENT-SCREEN | The frozen A2 arrays give \(M_{0.01}\approx-8.82736\times10^{-7}\), while the independent Fourier seed gives \(\lambda\approx0.02138145\); [`variational_report.json`](../numerics/results/vdp_a2_spectral_instability/variational_report.json) | `LOCAL-AMENDMENT / Numerically observed` | N-VAN-DER-POL-ATLAS and D-VAN-DER-POL-PERIODIC-MOMENT-INSTABILITY | The NPZ remains floating QA, not a true-profile enclosure.  V8A now supplies the needed true-orbit and interval-moment proof independently of this row. | None |
| D-VAN-DER-POL-PULSE-MOMENT-INSTABILITY | A negative whole-line centered moment, together with the explicit far-field pencil gap, gives a real positive \(L^2\) temporal eigenvalue; [`PULSE_1_SPECTRAL_INSTABILITY.md`](../van-der-pol/PULSE_1_SPECTRAL_INSTABILITY.md) | `LOCAL-AMENDMENT / Proved` | The physical time PDE and any exponentially localized true homoclinic satisfying the displayed moment and gap hypotheses | This is a conditional profile criterion; it does not by itself identify a saved seed or prove nonlinear instability or selection | None |
| N-VAN-DER-POL-PULSE-1-MOMENT-SCREEN | The frozen `pulse_1` arrays give \(M_{0.01}\approx-8.82736\times10^{-7}\), compatible with a finite-window positive eigenvalue near \(0.0214\); [`VDP_DYNAMICS_SCREENING_REPORT.md`](../numerics/VDP_DYNAMICS_SCREENING_REPORT.md) | `LOCAL-AMENDMENT / Numerically observed` | N-VAN-DER-POL-ATLAS and D-VAN-DER-POL-PULSE-MOMENT-INSTABILITY | The NPZ truncation is floating QA only.  V9A separately supplies the true-profile identity and outward-rounded whole-line moment. | None |
| D-VAN-DER-POL-NONLINEAR-ORBITAL-INSTABILITY | A real positive temporal eigenvalue implies nonlinear orbital Lyapunov instability in \(H^1\), modulo translations; [`NONLINEAR_ORBITAL_INSTABILITY.md`](../van-der-pol/NONLINEAR_ORBITAL_INSTABILITY.md) | `LOCAL-AMENDMENT / Proved` | The physical semilinear parabolic PDE, analytic-semigroup time map, and the positive eigenvalue hypothesis | Proves finite exit for some arbitrarily small perturbations; it does not prove generic growth, post-exit dynamics, nonlinear saturation, or pattern selection | None |
| V11A--V11B | Applying the nonlinear bridge to the frozen A2 and `pulse_1` positive eigenvalues gives, respectively, co-periodic and whole-line localized nonlinear orbital instability | `LOCAL-AMENDMENT / Locally validated; non-claim-bearing` | V8A or V9A together with D-VAN-DER-POL-NONLINEAR-ORBITAL-INSTABILITY | Independent replay of the target eigenvalue validations remains required; no dynamical selection is inferred | None |
...
| N-VAN-DER-POL-CANARD-SPLITTING-SCOUT | At \((r,\epsilon)=(0.08,1)\), all eight formal-entry surrogate splittings for \(Y=1,2,3,4\) and truncation orders \(m=2,3\) have floating-point simple roots in \(a_2\in[-1/80,0]\); [`VDP_CANARD_SPLITTING_SCOUT.md`](../numerics/VDP_CANARD_SPLITTING_SCOUT.md), [`fixed_r_report.json`](../numerics/results/vdp_canard_splitting_scout/fixed_r_report.json) | `LOCAL-AMENDMENT / Numerically observed` | The exact V1 central-chart field and the published formal canard jet | Candidate generation only: no invariant finite-\(r\) slow-manifold entry, true coincidence root or remainder bound, classification of \(a_2=0\), or high-winding connection | None |
