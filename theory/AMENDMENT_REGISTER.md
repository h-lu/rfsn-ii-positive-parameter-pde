...
child, `V2.CHART.ANALYTIC_NORMAL_FORM`, now also passes locally from the
  ...
  inversion.  These aggregates remain non-claim-bearing because independent
  replay is 1/2.  The remaining two P2d children, P2e,
